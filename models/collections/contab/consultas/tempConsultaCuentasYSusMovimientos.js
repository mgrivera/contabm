...
let schema = new SimpleSchema({
    ...
    cantidadMovimientos: { type: Number, label: 'cant movtos', optional: false, decimal: false },
    saldoInicial: { type: Number, label: 'Saldo inicial', optional: false, decimal: true },
    debe: { type: Number, label: 'Total debe', optional: false, decimal: true },
    haber: { type: Number, label: 'Total haber', optional: false, decimal: true },
    saldoFinal: { type: Number, label: 'Saldo final', optional: false, decimal: true },
